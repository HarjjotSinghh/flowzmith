...
/**
 * Generate Python type definitions from TypeScript schema
 * This ensures type safety across TypeScript and Python codebases
 */
...
const outputPath = path.join(__dirname, '..', 'python', 'schema.py');
...
console.log('✅ Python schema generated at:', outputPath);
