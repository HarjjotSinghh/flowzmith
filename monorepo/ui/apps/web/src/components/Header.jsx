...
export default function Header({ onMenuClick }) {
  ...
  return (
    <div className="h-16 bg-[#F3F3F3] dark:bg-[#1A1A1A] flex items-center justify-between px-4 md:px-6 flex-shrink-0">
      ...
      {/* Right side - Search, Wallet, Actions and profile area */}
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <button
          ...
          className={`flex items-center gap-2 h-10 px-4 md:px-6 rounded-full font-semibold text-sm transition-all duration-150 active:scale-95 font-inter ${
            walletConnected
              ? "bg-[#DCFCE7] dark:bg-[rgba(64,214,119,0.15)] border border-[#22C55E] dark:border-[#40D677] text-[#16A34A] dark:text-[#40D677]"
              : "bg-gradient-to-b from-[#6366F1] to-[#4F46E5] text-white hover:from-[#5B5FE7] hover:to-[#4338CA]"
          }`}
        >
          <Wallet size={16} />
