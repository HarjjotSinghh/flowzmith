...
## Contract Details
- **ID**: 706222a9-4525-4a43-b895-bdda127e6075
- **Name**: NewTest
- **Type**: custom
- **Network**: testnet
- **Generated**: 2025-09-27 12:28:39
- **Input Method**: api

## Project Structure
```
706222a9-4525-4a43-b895-bdda127e6075/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/706222a9-4525-4a43-b895-bdda127e6075
   ```
