...
## Contract Details
- **ID**: 729cb427-00ca-4e7e-a404-6aff9847fdb7
- **Name**: AutoToken
- **Type**: Token
- **Network**: emulator
- **Generated**: 2025-09-27 13:23:06
- **Input Method**: natural_language

## Project Structure
```
729cb427-00ca-4e7e-a404-6aff9847fdb7/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/729cb427-00ca-4e7e-a404-6aff9847fdb7
   ```
