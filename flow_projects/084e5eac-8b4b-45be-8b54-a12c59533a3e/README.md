...
## Contract Details
- **ID**: 084e5eac-8b4b-45be-8b54-a12c59533a3e
- **Name**: APITestToken
- **Type**: token
- **Network**: testnet
- **Generated**: 2025-09-27 03:31:21
- **Input Method**: api

## Project Structure
```
084e5eac-8b4b-45be-8b54-a12c59533a3e/
├── contracts/
│   └── APITestToken.cdc          # Main contract
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/084e5eac-8b4b-45be-8b54-a12c59533a3e
   ```
...
### Contract
- `contracts/APITestToken.cdc` - Main smart contract
