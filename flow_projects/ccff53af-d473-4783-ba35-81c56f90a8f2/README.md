...
## Contract Details
- **ID**: ccff53af-d473-4783-ba35-81c56f90a8f2
- **Name**: SoftwareTest
- **Type**: Custom
- **Network**: testnet
- **Generated**: 2025-09-27 13:03:52
- **Input Method**: markdown_context

## Project Structure
```
ccff53af-d473-4783-ba35-81c56f90a8f2/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/ccff53af-d473-4783-ba35-81c56f90a8f2
   ```
