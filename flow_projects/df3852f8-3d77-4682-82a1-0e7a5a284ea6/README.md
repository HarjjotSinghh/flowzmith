...
## Contract Details
- **ID**: df3852f8-3d77-4682-82a1-0e7a5a284ea6
- **Name**: AutoToken
- **Type**: token
- **Network**: emulator
- **Generated**: 2025-09-27 13:22:59
- **Input Method**: api

## Project Structure
```
df3852f8-3d77-4682-82a1-0e7a5a284ea6/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/df3852f8-3d77-4682-82a1-0e7a5a284ea6
   ```
