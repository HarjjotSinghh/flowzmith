...
## Contract Details
- **ID**: 84bfb2ac-cfc7-44bb-953c-4bb2758da0a2
- **Name**: NewTest
- **Type**: Custom
- **Network**: testnet
- **Generated**: 2025-09-27 12:28:46
- **Input Method**: markdown_context

## Project Structure
```
84bfb2ac-cfc7-44bb-953c-4bb2758da0a2/
├── contracts/
...
## Description
A smart contract for software tests
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/84bfb2ac-cfc7-44bb-953c-4bb2758da0a2
   ```
