...
## Contract Details
- **ID**: 12128244-c17e-472f-a26b-a225516a2def
- **Name**: Property
- **Type**: token
- **Network**: testnet
- **Generated**: 2025-09-27 10:44:52
- **Input Method**: api

## Project Structure
```
12128244-c17e-472f-a26b-a225516a2def/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/12128244-c17e-472f-a26b-a225516a2def
   ```
