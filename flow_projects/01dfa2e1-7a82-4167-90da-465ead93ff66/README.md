...
## Contract Details
- **ID**: 01dfa2e1-7a82-4167-90da-465ead93ff66
- **Name**: Organization
- **Type**: Custom
- **Network**: testnet
- **Generated**: 2025-09-27 02:47:08
- **Input Method**: markdown_context

## Project Structure
```
01dfa2e1-7a82-4167-90da-465ead93ff66/
├── contracts/
│   └── Organization.cdc          # Main contract
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/01dfa2e1-7a82-4167-90da-465ead93ff66
   ```
...
### Contract
- `contracts/Organization.cdc` - Main smart contract
