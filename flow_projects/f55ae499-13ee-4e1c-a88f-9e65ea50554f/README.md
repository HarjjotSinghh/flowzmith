...
## Contract Details
- **ID**: f55ae499-13ee-4e1c-a88f-9e65ea50554f
- **Name**: WalletManager
- **Type**: Custom
- **Network**: emulator
- **Generated**: 2025-09-27 13:08:03
- **Input Method**: markdown_context

## Project Structure
```
f55ae499-13ee-4e1c-a88f-9e65ea50554f/
├── contracts/
│   └── WalletManager.cdc          # Main contract
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/f55ae499-13ee-4e1c-a88f-9e65ea50554f
   ```
...
### Contract
- `contracts/WalletManager.cdc` - Main smart contract
