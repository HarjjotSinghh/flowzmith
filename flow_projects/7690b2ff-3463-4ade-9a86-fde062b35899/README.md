...
## Contract Details
- **ID**: 7690b2ff-3463-4ade-9a86-fde062b35899
- **Name**: AutoToken
- **Type**: Token
- **Network**: emulator
- **Generated**: 2025-09-27 13:33:22
- **Input Method**: natural_language

## Project Structure
```
7690b2ff-3463-4ade-9a86-fde062b35899/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/7690b2ff-3463-4ade-9a86-fde062b35899
   ```
