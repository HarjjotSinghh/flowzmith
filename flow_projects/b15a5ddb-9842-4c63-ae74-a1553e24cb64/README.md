...
## Contract Details
- **ID**: b15a5ddb-9842-4c63-ae74-a1553e24cb64
- **Name**: NewTest
- **Type**: custom
- **Network**: testnet
- **Generated**: 2025-09-27 12:26:37
- **Input Method**: api

## Project Structure
```
b15a5ddb-9842-4c63-ae74-a1553e24cb64/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/b15a5ddb-9842-4c63-ae74-a1553e24cb64
   ```
