...
## Contract Details
- **ID**: 01a24939-0e54-4c6e-9cb1-0d368393c6b2
- **Name**: AutoToken
- **Type**: token
- **Network**: emulator
- **Generated**: 2025-09-27 13:33:15
- **Input Method**: api

## Project Structure
```
01a24939-0e54-4c6e-9cb1-0d368393c6b2/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/01a24939-0e54-4c6e-9cb1-0d368393c6b2
   ```
