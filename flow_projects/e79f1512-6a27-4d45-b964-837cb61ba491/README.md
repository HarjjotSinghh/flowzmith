...
## Contract Details
- **ID**: e79f1512-6a27-4d45-b964-837cb61ba491
- **Name**: TestNew
- **Type**: custom
- **Network**: testnet
- **Generated**: 2025-09-27 12:37:19
- **Input Method**: api

## Project Structure
```
e79f1512-6a27-4d45-b964-837cb61ba491/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/e79f1512-6a27-4d45-b964-837cb61ba491
   ```
