...
## Contract Details
- **ID**: 2d171184-7c2b-451c-90b8-bd7d192e9ef6
- **Name**: WalletManager2
- **Type**: custom
- **Network**: testnet
- **Generated**: 2025-09-27 13:12:29
- **Input Method**: api

## Project Structure
```
2d171184-7c2b-451c-90b8-bd7d192e9ef6/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/2d171184-7c2b-451c-90b8-bd7d192e9ef6
   ```
