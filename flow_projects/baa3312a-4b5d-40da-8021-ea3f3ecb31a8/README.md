...
## Contract Details
- **ID**: baa3312a-4b5d-40da-8021-ea3f3ecb31a8
- **Name**: NewTest
- **Type**: Custom
- **Network**: testnet
- **Generated**: 2025-09-27 12:26:44
- **Input Method**: markdown_context

## Project Structure
```
baa3312a-4b5d-40da-8021-ea3f3ecb31a8/
├── contracts/
...
## Description
A test contract for storing tests (software tests)
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/baa3312a-4b5d-40da-8021-ea3f3ecb31a8
   ```
