...
## Contract Details
- **ID**: f7003ce9-744a-4cb8-96d6-49e1474785ee
- **Name**: Property
- **Type**: Token
- **Network**: testnet
- **Generated**: 2025-09-27 10:44:59
- **Input Method**: markdown_context

## Project Structure
```
f7003ce9-744a-4cb8-96d6-49e1474785ee/
├── contracts/
│   └── Property.cdc          # Main contract
...
## Description
A smart contract for managing properties buying and selling
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/f7003ce9-744a-4cb8-96d6-49e1474785ee
   ```
...
### Contract
- `contracts/Property.cdc` - Main smart contract
