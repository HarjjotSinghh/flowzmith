...
## Contract Details
- **ID**: 62af6e1f-c1d0-44f5-947c-1fdc701cc147
- **Name**: AutoToken
- **Type**: token
- **Network**: emulator
- **Generated**: 2025-09-27 13:31:29
- **Input Method**: api

## Project Structure
```
62af6e1f-c1d0-44f5-947c-1fdc701cc147/
├── contracts/
...
2. **Navigate to project directory**:
   ```bash
   cd flow_projects/62af6e1f-c1d0-44f5-947c-1fdc701cc147
   ```
