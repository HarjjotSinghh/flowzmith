        ...
        <div className="hidden lg:flex flex-col justify-between border-r border-border bg-card/80 p-12">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-display font-semibold text-foreground">
              Resume building smarter Flow contracts.
            </h1>
            <p className="text-lg text-muted-foreground">
              Access your AI workspace, review deployments, and collaborate instantly with your team.
            </p>
            <div className="grid grid-cols-1 gap-4">
              {[
                { icon: Sparkles, label: "AI-assisted generation" },
                { icon: Zap, label: "Real-time deployment" },
                { icon: ShieldCheck, label: "Security guardrails" },
              ].map((feature) => (
        ...
        <div className="flex flex-col justify-center px-6 py-12">
          <div className="mx-auto w-full max-w-md space-y-8">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-3xl font-display font-semibold text-foreground">Sign in</h2>
                <p className="text-muted-foreground">Access your Flowzmith workspace.</p>
              </div>
              <ThemeSwitcher />
            </div>
