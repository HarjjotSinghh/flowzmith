        ...
        <div className="space-y-6">
            ...
            {envCheck ? (
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className={envCheck.environment?.hasGithubClientId ? "text-primary" : "text-destructive"}>
                    {envCheck.environment?.hasGithubClientId ? "✅ Set" : "❌ Not Set"}
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="font-medium">GitHub Client Secret:</span>
                  <span className={envCheck.environment?.hasGithubClientSecret ? "text-primary" : "text-destructive"}>
                    {envCheck.environment?.hasGithubClientSecret ? "✅ Set" : "❌ Not Set"}
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="font-medium">NextAuth Secret:</span>
                  <span className={envCheck.environment?.hasNextAuthSecret ? "text-primary" : "text-destructive"}>
            ...
            <div className="space-y-2">
              ...
              {session && (
                <div className="mt-4">
                  ...
                  <pre className="bg-muted/60 p-4 rounded-2xl text-sm overflow-auto">
            ...
            <div className="space-y-4">
              <div>
                <a 
                  ...
                  className="inline-block bg-primary text-primary-foreground px-4 py-2 rounded-full hover:bg-primary/90"
                >
                  Test GitHub Sign In
                </a>
              </div>
              <div>
                <a 
                  ...
                  className="inline-block bg-secondary text-secondary-foreground px-4 py-2 rounded-full hover:bg-secondary/90"
                  target="_blank"
                >
              ...
              <div>
                <a 
                  ...
                  className="inline-block bg-accent text-accent-foreground px-4 py-2 rounded-full hover:bg-accent/90"
                  target="_blank"
                >
                  Check Session JSON
                </a>
          ...
          {envCheck?.error && (
            <div className="bg-destructive/10 border border-destructive/20 p-6 rounded-lg">
              ...
              <p className="text-destructive">{envCheck.error}</p>
            </div>
          )}
        </div>
      </div>
